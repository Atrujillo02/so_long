...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/23 20:18:19 by atrujill          #+#    #+#             */
/*   Updated: 2023/02/10 11:48:41 by atrujill         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_check_inside_wall(t_data *data)
{
	...
	if (data->nbr_collect < 1 || data->nbr_exits != 1 || data->nbr_players != 1)
...
void	ft_check_map(t_data *data, char *map_name)
{
	...
	while (control != 1)
	{
		...
		if ((int)ft_strlen(line) + control != data->map_width)
			ft_free_map_and_close(data, fd, line, 2);
